...
Blockly.Blocks['cozmo_on_start'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("/static/ATL-Logo.png", 15, 15, { alt: "*", flipRtl: "FALSE" }))
...
Blockly.Blocks['atl_logo'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("/static/Blockly-logo.png", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("+")
        .appendField(new Blockly.FieldImage("/static/Thymio01.jpg", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("+")
        .appendField(new Blockly.FieldImage("/static/Cozmo01.jpg", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("=")
        .appendField(new Blockly.FieldImage("/static/Like2.jpeg", 60, 60, { alt: "*", flipRtl: "FALSE" }));
    this.appendStatementInput("NAME")
        .setCheck(null)
        .appendField(new Blockly.FieldImage("/static/ATL-Logo.png", 100, 100, { alt: "*", flipRtl: "FALSE" }));
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(135);
